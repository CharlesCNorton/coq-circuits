(** * Arithmetic.Min8Bit: 8-Bit Minimum

    Returns the minimum of two 8-bit unsigned numbers.
...
Require Import Arithmetic.LessOrEqual8Bit.
...
Definition min_8bit
  ...
  let cond := less_or_equal_8bit a7 a6 a5 a4 a3 a2 a1 a0 b7 b6 b5 b4 b3 b2 b1 b0 in
...
Definition min_8bit_spec
  (a7 a6 a5 a4 a3 a2 a1 a0 b7 b6 b5 b4 b3 b2 b1 b0 : bool)
  : bool * bool * bool * bool * bool * bool * bool * bool :=
  if Nat.leb (bits_to_N a7 a6 a5 a4 a3 a2 a1 a0)
...
Theorem min_8bit_correct
  : forall a7 a6 a5 a4 a3 a2 a1 a0 b7 b6 b5 b4 b3 b2 b1 b0,
    min_8bit a7 a6 a5 a4 a3 a2 a1 a0 b7 b6 b5 b4 b3 b2 b1 b0 =
    min_8bit_spec a7 a6 a5 a4 a3 a2 a1 a0 b7 b6 b5 b4 b3 b2 b1 b0.
Proof.
  intros.
  unfold min_8bit, min_8bit_spec, select_bit.
  unfold less_or_equal_8bit, greater_than_8bit, gt_bit, eq_bit, bits_to_N.
...
Lemma min_idempotent
  : forall a7 a6 a5 a4 a3 a2 a1 a0,
    min_8bit a7 a6 a5 a4 a3 a2 a1 a0 a7 a6 a5 a4 a3 a2 a1 a0 =
    (a7, a6, a5, a4, a3, a2, a1, a0).
Proof.
  intros.
  unfold min_8bit, select_bit, less_or_equal_8bit.
...
(** Min(255, 0) = 0. *)
Lemma min_255_0
  : min_8bit true true true true true true true true
...
(** Min(0, 255) = 0. *)
Lemma min_0_255
  : min_8bit false false false false false false false false
...
(** Min(5, 10) = 5. *)
Lemma min_5_10
  : min_8bit false false false false false true false true
...
Definition min_8bit_num_neurons : nat := 89.
Definition min_8bit_num_params : nat := 267.
Definition min_8bit_depth : nat := 6.
